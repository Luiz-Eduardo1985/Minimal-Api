...
using minimal_api.Dominio.Models;
...
//rota para retornar lista de administradores
...
//rota para retornar apenas 1 administrador
...
ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
{
    ...
    if (string.IsNullOrEmpty(veiculoDTO.Marca))
        validacao.Mensagens.Add("Digite o fabricando do veiculo.");

    if (veiculoDTO.Ano < 1950)
        validacao.Mensagens.Add("Escolha um ano valido para cadastrar o veiculo");
...
//consulta retorna apenas 1  veiculo pelo ID
